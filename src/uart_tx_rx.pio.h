...
static inline void uart_tx_program_stop(PIO pio, uint sm, uint offset, uint pin_tx, uint baud) {
...
static inline void uart_tx_program_start(PIO pio, uint sm, uint offset, uint pin_tx, uint baud) {
