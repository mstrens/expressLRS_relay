...
static inline pio_sm_config crsf_uart_tx_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + crsf_uart_tx_wrap_target, offset + crsf_uart_tx_wrap);
...
#define crsf_uart_rx_wrap_target 0
#define crsf_uart_rx_wrap 8

static const uint16_t crsf_uart_rx_program_instructions[] = {
            //     .wrap_target
...
static inline pio_sm_config crsf_uart_rx_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + crsf_uart_rx_wrap_target, offset + crsf_uart_rx_wrap);
    return c;
}
